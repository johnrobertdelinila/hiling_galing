...
public class VisionActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takePicture.setOnClickListener(view -> takePictureFromCamera());
    }
