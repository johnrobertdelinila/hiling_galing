...
package com.lorma.hilinggaling.camera;
...
import com.lorma.hilinggaling.objecttsearch.SearchEngine.SearchResultListener;
...
public class WorkflowModel extends AndroidViewModel implements SearchResultListener {
  ...
  @Override
  public void onSearchCompleted(DetectedObject object, List<Object> objects) {
    ...
    searchedObject.setValue(new SearchedObject(getContext().getResources(), confirmedObject, objects));
  }
